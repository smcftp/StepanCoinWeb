...
export default function Stickers() {
    return (
        <section className="h-[518px] sm:h-[616px]  w-full relative flex flex-col justify-center">
            ...
            <Image src='/sc_st_5.svg' alt="Sticker 2" width={140} height={140} className="absolute top-4 right-4 xs:scale-125 sm:scale-[2] sm:top-14 sm:right-20"/>
            <Image src='/sc_st_7.svg' alt="Sticker 3" width={140} height={140} className="absolute bottom-4 right-4 xs:scale-125 sm:scale-[2] sm:bottom-14 sm:right-20"/>
            <Image src='/sc_st_4.svg' alt="Sticker 4" width={140} height={140} className="absolute bottom-4 left-4 xs:scale-125 sm:scale-[2] sm:bottom-14 sm:left-20"/>
        </section>
    )
}